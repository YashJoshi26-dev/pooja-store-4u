...
export default function AddProduct() {
  ...
  const [form, setForm] = useState({
    name:"", parentCategory:"", category:"", price:"", discountPrice:"",
              ...
              <div className="ap-panel" style={S.card}>
                ...
                <div style={S.g2}>
                  <div style={S.f}>
                    ...
                    <select className="ap-select" value={form.parentCategory} onChange={handleParentCategory}>
                  ...
                  {subCategories.length>0&&(
                    <div style={S.f}>
                      <label style={S.lbl}>Sub Category <span style={{color:"#ff3f6c"}}>*</span></label>
                      <select className="ap-select" value={form.category} onChange={e=>setForm(f=>({...f,category:e.target.value}))}>
                        <option value="">Select sub-category</option>
                        {subCategories.map(s=><option key={s.id} value={s.label}>{s.label}</option>)}
                      </select>
                    </div>
                  )}
                </div>
                {form.category&&(
                  <div style={{background:"#fff0f4",border:"1px solid #ffd0db",borderRadius:8,padding:"8px 14px",marginBottom:16,fontSize:12,color:"#ff3f6c",fontWeight:600}}>
