...
function SocialIcon({ name }) {
  const icons = {
    ...
    youtube:   <svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14"><path d="M19.615 3.184C21.403 3.184 23 4.781 23 6.569v10.862c0 1.788-1.597 3.385-3.385 3.385H4.385C2.597 20.816 1 19.219 1 17.431V6.569C1 4.781 2.597 3.184 4.385 3.184h15.23zM10 16l6-4-6-4v8z"/></svg>,
...
export default function Home() {
 ...
 // ✅ NEW ARRIVALS — last 7 days only
  ...
  if (error) return (
    <div className="min-h-screen fleax items-center justify-center flex-col gap-4">
        ...
        Support: +91 94071 37528
            ...
            <div className="flex gap-3 mt-5">
              {[
                ...
                { icon: "youtube", href: "https://youtube.com/@poojastore4u?si=S2MQf-vrrz4799rt", bg: "#FF0000" },
